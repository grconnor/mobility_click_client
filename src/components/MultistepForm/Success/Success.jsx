          ...
          <div className="flexbox-success-inner-container">
            ...
            <div className="flexbox-success-whathappens-container">
              ...
              <div className="flexbox-success-whathappens-list-container">
                <ul>
                  <li>
                    Vi kommer kontakta dig för att gå igenom bilens skick och
                    utrustning.
                  </li>
                  <li>Våra erfarna inköpare värderar din bil.</li>
                  <li>Vi återkommer till dig med bästa möjliga bud.</li>
                  <li>
                    Efter accepterat bud, ordnar vi med kontroll av bil,
                    betalning till ditt konto, och upphämtning.
                  </li>
                </ul>
              </div>
            </div>
